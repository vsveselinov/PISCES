...
wget "https://github.com/helium/gateway-rs/releases/download/v1.0.0/helium-gateway-1.0.2-armv7-unknown-linux-musleabihf.tar.gz" -P "$GATEWAY_RS_PATH/"
wait
# Unzip the pack
tar -xvf "$GATEWAY_RS_PATH/helium-gateway-1.0.2-armv7-unknown-linux-musleabihf.tar.gz" -C "$GATEWAY_RS_PATH/"
wait
...
echo "DISTRIB_RELEASE=2023.04.17" | sudo tee /etc/lsb_release
wait
echo "version update"
wait
